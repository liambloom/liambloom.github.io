...
function MenuBeta(color) {//color of menu
...
function OptionBeta(text, link, location, color) {//href, innerHTML, float, color(if different from inherited)
