...
var lupinb = {
	version: "&beta;1.4.1.0.0.6",//version
	logo: "https://liambloom.github.io/favicon/beta/favicon_beta_vector.svg",
	...
	dom: {
		...
		add: function(e) {
			...
			lubinb.dom.id(e).parentNode.removeChild(lupinb.dom.id(e))
